...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("WangLinXMusic/assets/WangLinXMusicl2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((1157, 1158))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('WangLinXMusic/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('WangLinXMusic/assets/font.ttf', size=60)
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member:
        ...
        try:
            ...
            pic = "WangLinXMusic/assets/upic.png"
